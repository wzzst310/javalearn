package com.wjjzst.ads.learn.linkedlist.circle;

import com.wjjzst.ads.learn.common.AbstractList;
...
public class JosephusCircleLinkedList<E> extends AbstractList<E> {
    ...
    public E remove() {
        ...
        E element = remove(current); //移除了current 没有指向current  可能被回收 需要先将current.next备份
        if (size == 0) {
            current = null;
        } else {
            current = next;
